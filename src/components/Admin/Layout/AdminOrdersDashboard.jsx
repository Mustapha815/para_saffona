...
const AdminOrdersDashboard = () => {
  ...
  // Stats cards data
  const statsCards = [
    { title: 'Total Orders', value: stats.total, icon: Package, gradient: 'from-blue-500 to-indigo-500' },
    { title: 'Pending Orders', value: stats.pending, icon: Clock, gradient: 'from-orange-500 to-red-500' },
    { title: 'Delivered Orders', value: stats.delivered, icon: CheckCircle, gradient: 'from-emerald-500 to-teal-500' },
    { title: 'Total Revenue', value: `${formatCurrency(stats.revenue)} MAD`, icon: DollarSign, gradient: 'from-purple-500 to-pink-500' }
  ];
