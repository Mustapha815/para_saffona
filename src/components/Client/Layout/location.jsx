...
export default function LocationSection() {
  ...
  return (
    <section dir="rtl" className="w-full py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-6">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">زورونا</h2>
          <p className="text-gray-600 max-w-md mx-auto text-lg">
            تعالوا لزيارتنا في موقعنا أو تواصلوا معنا عبر الطريقة التي تفضلونها
          </p>
        </div>
          ...
          <div className="w-full lg:w-1/2 rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
            <div className="relative h-full">
              ...
              <div className="absolute bottom-4 left-4 bg-white px-4 py-2 rounded-full shadow-md flex items-center gap-2">
                ...
                <span className="text-sm font-medium">نحن هنا!</span>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">كل أيام الأسبوع: 10 صباحاً - 11 مساءً</p>
